...
{      
    ...
    {   
         ...
         * @return   
         */        
        private static function convertIntegerStr( str:String ):String   
        {   
         ...
         * @return   
         */        
        private static function convertDecimalStr( str:String ):String   
        {   
            var newStr:String = "";   
         ...
         * @return   
         */        
        private static function getUnitCount( num:Number ):int  
        {   
