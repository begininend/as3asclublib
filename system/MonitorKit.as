package org.asclub.system{
    ...
    public class MonitorKit extends Sprite
	{
		...
		//最小内存占用
		private var _minMem:Number = Number.MAX_VALUE;
        ...
        private function enterFrameHandler(evt:Event):void 
		{
			...
			var curMem:Number = Number((System.totalMemory/1024/1024).toFixed(3));
			_maxMem = (curMem > _maxMem ? curMem : _maxMem);
			_minMem = (curMem > _minMem ? _minMem : curMem);
